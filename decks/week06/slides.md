...
Semana 6 | Planificación de la estrategia de inversión
<div class="subtitle">Mercados y Riesgos Financieros • <em>Noviembre 12, 2025</em></div>
</section>
...
## 6.1.5 Momentum — Riesgos y control cuantitativo
...
## 6.2.1 Valor — Filosofía y objetivo
...
## 6.2.4 Valor — Margen de seguridad y catalizadores
...
## 6.3.2 Opciones Reales — Condiciones de valor
- **Tres condiciones**:
...
## 6.3.3 Opciones Reales — Analogía con opciones financieras
- **Mapeo**: 
...
## 6.3.6 Opciones Reales — Checklist y comparación con DCF
...
## 6.4.1 Estructura de Capital — Costo de capital y mínimos
...
## 6.4.2 Estructura de Capital — Óptimo práctico (APV)
